...
class Ensemble:
  ...
  def __init__(self, predictors, device='cpu', n_best=10, max_length=512, stride=256, no_answer=True):
    self.device = device

    self.predictor_ParsBERT = predictors[0]
    self.predictor_mBERT = predictors[1]
    self.predictor_alBERT = predictors[2]
